...
// Given a sorted list 3, 5, 6, 8, 11, 12, 14, 15, 17, 18 and using the recursive binary search 
// algorithm, identify the sequence of numbers that each recursive call will search to try and find 16.
...
// that you want to search. There is no server-side to this program. All of this should be done using React.

// 1) Linear search

// Given the following dataset, find out how many tries it took to search for a particular item in the 
// dataset. If the item is not in the dataset, provide a message and indicate how many searches it took 
// to find that out.
...
// Use array.sort to sort the dataset. Then implement a binary search to find a particular value in 
// the dataset. Display how many tries it took to search for a particular item in the dataset using 
// binary search. If the item is not in the dataset, provide a message and indicate how many searches 
...
// Can you express this process as a search algorithm? Implement your algorithm to find a book whose 
...
// ** No coding is needed for these drills**. Once you have answered it, you can then code the tree 
// and implement the traversal to see if your answer is correct.
...
// Using your BinarySearchTree class from your previous lesson, create a binary search tree with the 
// following dataset: 25 15 50 10 24 35 70 4 12 18 31 44 66 90 22. 
